...
\begin{equation*}
    K_{i}(t) = \left\{k | \max_{t'} x_{i,t'} \in C_k < t   \right\} 
\end{equation*}
...
For a given conflict $k$, the maneuver introduced delays $\{d_{i, k} | i \in I_k\}$ should depend on the actual maneuver performed.
Therefore we introduce a set of maneuver parameters $\mathbf{a}_k$ for each conflict $k$ which determines the resulting maneuver delays for both involved flights.
\begin{equation*}
    d_{ik} = \mathcal{D}_{ik}(\mathbf{a}_k) \quad \forall i \in I_k \; .
\end{equation*}
In general, $\mathcal{D}_{ik}$ is some function depending on the spatial configuration of the conflict trajectory points.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
